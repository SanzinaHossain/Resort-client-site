...
export default function RoomBookingHooks() {
  ...
  const handleRoomBooking = (e) => {
    ...
    fetch("https://resort-server-delta.vercel.app/roomBooking", {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        {
          ...
          if (data) {
            ...
            console.log("Bookings not successful")
          }
        }
      })
  }
  return { handleRoomBooking }
}
